r"""
lock_scan.py -- Kompatibilitaets-Shim (lock-master Stack)
...
`import lock_scan` und `python lock_scan.py` funktionieren unveraendert -- das ist
...
_REAL = Path(__file__).resolve().parent / "pure-locking" / "lock_scan.py"
